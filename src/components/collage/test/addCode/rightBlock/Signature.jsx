...
const Signature = ({
  ...
  function Add() {
    ...
    setQuestion( { ...question, parameters: [...question.parameters ,{
     paramName: "",
      type: "String",
    }] })
  }
  ...
  return (
    <div>
        ...
        <div className="bg-[#F8F8F9] mt-12 px-6 p-6 rounded-lg">
              ...
              <Disclosure>
                {({ open }) => (
                  <div className="mb-4 relative border  rounded-xl py-1">
                    ...
                    <select    className="w-full py-[.93rem] rounded-xl border-none border-opacity-30 bg-gray-100 text-sm font-medium"
                    name="returnType"
          ...
          <div className="w-full relative h-12">
            <button className="absolute right-0 bg-blued text-white rounded-lg px-5 flex gap-2 py-2" onClick={Add}>
