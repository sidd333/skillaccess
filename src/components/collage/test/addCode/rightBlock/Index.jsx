...
const Code = ({
  ...
  return (
    <div className="font-dmSans">
      <h2 className="font-bold mb-3 text-xl">Coding Language: {question.codeLanguage} </h2>
      ...
      <div className="p-2 mt-4 rounded-lg">
        ...
        {toggle === 1 ? (
          <Signature question={question} handleChanges={handleChanges}     handleQuestionChange={handleQuestionChange} setQuestion={setQuestion}
          />
        ) : toggle === 2 ? (
          <Initial question={question} handleChanges={handleChanges} />
        ) : toggle === 3 ? (
          <TestCases question={question} handleChanges={handleChanges}
