        ...
        <div className="   my-2 rounded-lg tracking-wide justify-between  ">
          <div className="grid grid-rows-1 w-[65vw]">
            ...
            <div className=" sm:mt-5 rounded-lg tracking-wide justify-between  ">
              <div className=" grid grid-cols-6 row-span-2 gap-x-10 gap-y-3 p-3 bg-gray-100 rounded-lg border border-blued h-28 w-[64vw] mx-auto">
                {" "}
                ...
                <div className="col-span-4 line-clamp-2 text-xs font-normal text-gray-400 ">
                  ...
                  Assumenda rerum praesentium sapiente consectetur deserunt qui
                  non eius, nam, quia, odit facere? Quia, iste! Totam sunt,
                  nulla nostrum fuga enim repudiandae.
                </div>
